...
class Converter(object):
    ...
    def __init__(self,lambert="Lambert 93"):
    ...
    def geo_to_cart(self,lat,lon,h):
        """
        ...
        N = self.a / math.sqrt(1.0 - self.e2*(math.sin(lat))**2)        # angles en rad
    ...
    def EN_to_cart(self,E,N,h):
        ...
        result = self.geo_to_cart(temp[2],temp[1],temp[0])
